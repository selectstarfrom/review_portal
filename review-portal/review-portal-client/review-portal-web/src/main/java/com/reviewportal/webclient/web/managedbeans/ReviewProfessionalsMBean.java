...
public class ReviewProfessionalsMBean extends AbstractMBean {
    ...
    private void mock() {
        ...
        for (int lI = 0; lI < 15; lI++) {
            ...
            lProfessionReviewDTO.setReview("ghsd fsdkfhsd fsdkfhsd sd fsdf sdfs" + "df sdfsdfsdf s" + "df sdfsdf"
                    + "sd fsdaf sdfsdfjhsdf" + " sfkjhjsdfjsdf" + " ikhds hkjhfkdshklsd" + "fsd gsdj gjfksk gkjhgdfghd"
                    + " sdgkhgdh lkndf " + "df ghjhdkfglk dfh g" + " oig sdh ls" + "sd gjkds fgkd fg ...");

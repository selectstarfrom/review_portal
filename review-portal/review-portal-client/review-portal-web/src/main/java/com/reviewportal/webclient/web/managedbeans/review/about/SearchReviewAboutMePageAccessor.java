 ...
 *
 */
@ManagedBean(name = "searchReviewAboutMePageAccessor")
@ViewScoped
public class SearchReviewAboutMePageAccessor extends AbstractMBean implements IPropertyAccessor {

    private static final long serialVersionUID = 6115650692332938503L;
    ...
    public SearchReviewAboutMePageAccessor() {
        super();
    }

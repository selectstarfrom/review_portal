 ...
 *
 */
@ManagedBean(name = "searchReviewByMePageAccessor")
@ViewScoped
public class SearchReviewByMePageAccessor extends AbstractMBean implements IPropertyAccessor {

    private static final long serialVersionUID = -282714160490212771L;
    ...
    public SearchReviewByMePageAccessor() {
        super();
    }

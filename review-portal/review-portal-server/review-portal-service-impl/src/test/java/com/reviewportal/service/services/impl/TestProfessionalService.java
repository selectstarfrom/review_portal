...
@Transactional
@Rollback(false)
public class TestProfessionalService {

    static Logger LOGGER = Logger.getLogger(TestProfessionalService.class.getName());
    ...
    @Test
    public void testCreateProfessional1() throws Exception {
        List<ProfessionalDTO> lDtos = new ArrayList<>();
        ...
        for (int lI = 0; lI < 50; lI++) {
            ...
            lDto.setMembershipType(MembershipType.PROFESSIONAL);
        ...
        professionalMemberService.save(lDtos);
    }
